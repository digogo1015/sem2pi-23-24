...
import pt.ipp.isep.dei.esoft.project.utils.ComparatorAscendingPrice;

import java.util.ArrayList;

import static org.junit.jupiter.api.Assertions.*;

class ComparatorAscendingPriceTest {

    @Test
    @DisplayName("Verify above zero")
    void compare() {
        ComparatorAscendingPrice cmp = new ComparatorAscendingPrice();

        Advertisement advertisement1 = new Advertisement("12/04/2023",
                new Request(new House(new PropertyInfo(new Address("Street","City","District",
