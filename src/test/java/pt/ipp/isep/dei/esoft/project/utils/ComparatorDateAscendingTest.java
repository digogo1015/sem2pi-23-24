...
import pt.ipp.isep.dei.esoft.project.utils.ComparatorDateAscending;

import java.util.ArrayList;

import static org.junit.jupiter.api.Assertions.*;

class ComparatorDateAscendingTest {

    @Test
    @DisplayName("Verify above zero")
    void compare() {
        ComparatorDateAscending cmp = new ComparatorDateAscending();
