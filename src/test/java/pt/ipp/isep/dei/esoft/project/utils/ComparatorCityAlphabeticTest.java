...
import pt.ipp.isep.dei.esoft.project.utils.ComparatorCityAlphabetic;

import java.util.ArrayList;

import static org.junit.jupiter.api.Assertions.*;

class ComparatorCityAlphabeticTest {


    @Test
    @DisplayName("Verify above zero")
    void compare() {
        ComparatorCityAlphabetic cmp = new ComparatorCityAlphabetic();
